...
2. Header - WE NEED A NAME for the site!
3. Footer- for our dev team & editor contributers & link to Admin signin page
...
4/11: react timeline for article view, add Google Maps autocomplete for location field, custom pins, display legend
Goal:
4/17: Can add article to DB, can get articles from DB (update redux flow)
4/18: Fix split screen view, Style article and map view, user click on pin functionality, error handling
